							...
							<div class="row text-light">
								<div class="col-md-6">
									<div class="row justify-content-center my-5">
										<div class="col-md-6">
											<span style="font-size: 15pt;"><b>Nama Customer</b></span><br>
											<span style="font-size: 15pt;"><b>Tanggal Booking</b></span><br>
											<span style="font-size: 15pt;"><b>Jumlah Tiket</b></span><br>
											<span style="font-size: 15pt;"><b>Total Bayar</b></span>
										</div>
										<div class="col-md-6">
											<span style="font-size: 15pt;">: {{ $c->nama_customer }}</span><br>
											<span style="font-size: 15pt;">: {{ tgl_indo(date('Y-m-d', strtotime($c->tanggal_pemesanan))) }}</span><br>
											<span style="font-size: 15pt;">: {{ $c->jumlah_tiket }} Tiket</span><br>
											<span style="font-size: 15pt;">: Rp. {{ number_format($c->total_harga,0,'.','.') }}</span>
										</div>
									</div>
								</div>
								<div class="col-md-6 text-center">
									{!! QrCode::size(180)->backgroundColor(255, 255, 204)->generate($c->kode_pembayaran) !!} <br>
