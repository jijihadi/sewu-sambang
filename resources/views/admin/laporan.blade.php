...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Laporan Pemesanan</h4>
    </div>
        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
                    <h6 class="card-title mb-0">Tabel Laporan Pemesanan</h6>
                    <div class="dropdown">
                        <a href="{!! url('/admin/cetak_laporan') !!}">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    @if($p->metode_pembayaran=='1')
                                        <td><p class="text-info">Cash</p></td>
                                    @elseif($p->metode_pembayaran!='1')
                                        <td><p class="text-success">Transfer</p></td>
                                    @endif
                                    <td>
