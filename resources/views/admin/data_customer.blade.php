...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Data Customer</h4>
    </div>
        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
                    <h6 class="card-title mb-0">Tabel Data Customer</h6>
                    <div class="dropdown">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/hapus_customer/{{ $c->id }}" class="btn btn-danger btn-sm"><i class="link-icon" data-feather="trash"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                                @endforeach
