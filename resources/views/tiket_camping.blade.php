	...
	<div class="super_container">
		...
		<div class="home">
			...
			<div class="home_content">
				<div class="home_title">Tiket Camping</div>
			</div>
		</div>
		...
		<div class="intro">
			<div class="container">
				<div class="row">
					<div class="col-lg-7">
						<div class="intro_image"><img src="{{ url('/') }}/travelix/images/intro.png" alt=""></div>
					</div>
					<div class="col-lg-5">
						<div class="intro_content">
							<div class="intro_title">Pemesanan Tiket Camping</div>
							<form action="/beli_camping" method="post">
								@csrf
								<input type="hidden" value="{{ Auth::user()->id }}" class="form-control" name="user_id">
								<input type="hidden" value="1" class="form-control" name="tiket_id">
								<div class="form-group">
									<label for="">Nama Customer</label>
									<input type="text" value="{{ Auth::user()->name }}" class="form-control" name="nama_customer">
								</div>
								<div class="form-group">
									<label for="">Tanggal Booking</label>
									<input type="date" value="{{ date('Y-m-d') }}" class="form-control" name="tanggal_pemesanan">
								</div>
								<div class="form-group">
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						<div class="section_title">Fasilitas Kami</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-10 offset-lg-1 text-center">
						<p class="stats_text">Beberapa Fasilitas Dari Kami Yang Bisa Anda Gunakan Saat Anda Bercamping Di Sewu Sambang Ini. </p>
					</div>
				</div>
				<div class="row justify-content-center">
					@foreach($fasilitas as $f)
					<div class="col-md-6 text-center">
						<span><b style="color:blueviolet; font-size: 15pt;">{{ $f->nama_fasilitas }}</b></span><br>
						<img src="{{ url('/') }}/assets/{{ $f->gambar_fasilitas }}" style="width: 300px;" alt=""><br>
						<span><b>Rp. {{ number_format($f->harga_fasilitas, 0, '.','.') }}</b></span><br>
						<span>{{ $f->deskripsi_fasilitas }}</span>
					</div>
					@endforeach
				</div>
			</div>
